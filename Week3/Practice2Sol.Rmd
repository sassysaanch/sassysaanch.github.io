...
2.1 Create a cross-tabulation/contingency table of neighborhood_group against accommodation type.

```{r}
table(nyc_airbnb_subset$neighbourhood_group, nyc_airbnb_subset$room_type)
```
