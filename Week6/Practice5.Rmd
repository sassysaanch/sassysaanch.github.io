...
Create a scatterplot of accommodation plot against accommodation type. Before you do so, try to hypothesize the kind of trend you expect to see and why. A quick google search may help.
...
2. Calculate the mean and standard deviation of the babies. 
...
6. How many mothers are white vs not? Generate a plot for racial group vs mage. Use the cheatsheet to decide the type of plot that would make most sense. 
